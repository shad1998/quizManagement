...
<div class="Container">
	<br> <h1 class="text-center text-primary">JAVASCRIPT QUIZ</h1><br>
	<div class='card'>
	...
	<form action="checkjs.php" method="post">
	<?php
		$q2="SELECT * from question where sub_id='s2'";
		...
		while($rows=mysqli_fetch_array($query)){
			?>
			<div class="card">
				<h4 class="card-header bg-primary text-white"><?php echo ($i%200).". " ?><?php echo  $rows['question'];?> </h4>
