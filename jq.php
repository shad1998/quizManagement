...
<div class="Container">
	<br> <h1 class="text-center text-primary">JQUERY QUIZ</h1><br>
	<div class='card'>
	...
	<form action="checkjq.php" method="post">
	<?php
		$q2="SELECT * from question where sub_id='s4'";
		...
		while($rows=mysqli_fetch_array($query)){
			?>
			<div class="card">
				<h4 class="card-header bg-primary text-white"><?php echo ($i%400).". " ?><?php echo  $rows['question'];?> </h4>
